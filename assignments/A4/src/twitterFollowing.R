...
csv <- read.table('output/twitterFollowing.csv',header = FALSE,sep = ",")
numRows <- nrow(csv)
...
b <- plot(ordered$V2,col = cols,main="Twitter Following/Friends Plot",xlab = "Twitter Users Followed",ylab = "Following Count",xaxt='n')
...
text(nelsonIndex,5000,paste("Michael Nelson:",count$V2),col = "red")
# Summary Stats
