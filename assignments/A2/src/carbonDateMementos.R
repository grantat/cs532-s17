...
emptyDate <- subset(mementoDays, mementoDays$V3 != "")
plot(withMementos$V3,withMementos$V2,ylab="Number of Mementos",xlab="Age in Days",main="Scatter Plot for Days vs. Mementos",las=1)
