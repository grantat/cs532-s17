...
\lstinputlisting[frame=single,caption={Python script to find KNN values},label=lst:q1download,captionpos=b,numbers=left,showspaces=false,showstringspaces=false,basicstyle=\footnotesize]{\srcPath/knn.py}
